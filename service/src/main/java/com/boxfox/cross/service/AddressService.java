...
public class AddressService  extends AbstractService{
        ...
        doAsync(future -> {
                useContext(ctx -> {
                    ...
                    if(result.size()>0){
                        ...
                        Wallet wallet = Wallet.fromRecord(record);
    ...
    public void getMajorWallet(String uid, String symbol, Handler<AsyncResult<Wallet>> res){
        doAsync(future -> {
            useContext(ctx -> {
                Wallet wallet = null;
    ...
    public void setMajorWallet(String uid, String symbol, String address, Handler<AsyncResult<Void>> res){
        doAsync(future -> {
            useContext(ctx -> {
