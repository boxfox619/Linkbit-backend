...
interface TransactionUsecase {
    ...
    fun getTransactionList(ctx: DSLContext, symbol: String, uid: String, address: String, page: Int, count: Int): List<TransactionModel>
    fun getAllTransactionList(ctx: DSLContext, symbol: String, uid: String, page: Int, count: Int): List<TransactionModel>
    fun getTransactionCount(ctx: DSLContext, symbol: String, uid: String, address: String): Int
